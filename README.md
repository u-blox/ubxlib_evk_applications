...
The purpose of this resporitory is to provide example EVK applications which run on the Raspberry PI or Windows. This project was originally taken from the [ubxlib-cellular-tracker-xplr-iot](https://github.com/u-blox/ubxlib_cellular_applications_xplr_iot) repository, but that XPLR repo is dedicated for building on the XPLR-IoT-1 Development platform. This repository is dedicated for applications based on ubxlib for the Windows and Raspberry PI platform, 
